javascript: (function () {
	document.querySelector("#dojoUnique7 > div.auiPortletHead > div > div.auiPortletTool > div.auiPortletAction > a").click();
	setTimeout(function () {
		var today = new Date();
			...
			"#tmp_map_from > option:nth-child(" +
				(
					document
						...
						.innerHTML.substr(0, document.querySelector("#tmp_map_from").innerHTML.indexOf(document.querySelector("#mb_settings > span").innerHTML))
						.match(/<option/g) || []
				).length +
				")"
		).selected = true;
